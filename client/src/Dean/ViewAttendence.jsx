...
const ViewAttendance = () => {
  ...
  const fetchAttendanceData = () => {
    ...
    const data = [
      ...
      { rollNo: 4, name: 'Emily Davis', fathersName: 'Mr. Davis', present: true, email: 'emily.davis@example.com' },
      { rollNo: 5, name: 'Chris Brown', fathersName: 'Mr. Brown', present: false, email: 'chris.brown@example.com' },
      { rollNo: 6, name: 'Sophia Wilson', fathersName: 'Mr. Wilson', present: true, email: 'sophia.wilson@example.com' },
  ...
  return (
    <div className="bg-black mb-6 h-screen">
      <div className='my-5'>
